...
clasica::clasica(QString numero_tarjeta,double monto,QString nombre_cliente,QString pin,QString id):
    credito(numero_tarjeta,monto,nombre_cliente,pin,id){
}
QString clasica::toQString()const{
    QString ss;
...
void clasica::setGastos(double compra){
...
void clasica::setTipo(QString tipo){
    this->tipo=tipo;
}
QString clasica::getTipo()const{
    return tipo;
}
