...
public:
    ...
    void setupUi(QDialog *agregar_tarjeta)
    {
        ...
        pushButton_2 = new QPushButton(agregar_tarjeta);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(180, 320, 99, 27));
    ...
    void retranslateUi(QDialog *agregar_tarjeta)
    {
        ...
        pushButton_2->setText(QApplication::translate("agregar_tarjeta", "Cancelar", 0));
    } // retranslateUi
