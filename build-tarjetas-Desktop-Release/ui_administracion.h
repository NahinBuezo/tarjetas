...
public:
    ...
    void setupUi(QDialog *administracion)
    {
        ...
        nueva_card->setGeometry(QRect(460, 230, 171, 27));
        ...
        ver_datos = new QPushButton(administracion);
        ver_datos->setObjectName(QStringLiteral("ver_datos"));
        ver_datos->setGeometry(QRect(460, 160, 99, 27));
    ...
    void retranslateUi(QDialog *administracion)
    {
        ...
        nueva_card->setText(QApplication::translate("administracion", "Agregar Nueva tarjeta", 0));
        ...
        ver_datos->setText(QApplication::translate("administracion", "Ver datos", 0));
    } // retranslateUi
